...
(function() {
  var async, cached_files, collectDependencies, compile, fs, parseFile, parsers, path, resolveDependencyChain, resolvePath, root;
  ...
  compile = function(main_file, cb) {
    return collectDependencies(main_file, function(err) {
